...
export const experiences = [
    ...
    },
    {
        ...
        details: [
            ...
            "Developed modern, responsive user interfaces by integrating front-end frameworks like React with Tailwind CSS.",
            "Managed robust backend systems, applying expertise in Object-Oriented Programming (OOP), database management (SQL), and advanced debugging.",
        ],
    },
];
