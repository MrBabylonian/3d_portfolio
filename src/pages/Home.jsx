...
const Home = () => {
	...
	const adjustIslandForScreenSize = () => {
		...
		const islandRotation = [0.1, -1.4, 0];
		let islandScale;
	...
	const [planePosition, planeRotation, planeScale] = adjustPlaneForScreenSize();
		...
		<section className="w-full h-screen relative overflow-hidden">
			...
			<Suspense fallback={<Loader />}>
				...
				>
					...
					<Sky isRotating={isRotating} isIslandMoving={isIslandMoving} />
