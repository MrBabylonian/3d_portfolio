...
const Contact = () => {
	...
	return (
		<section className="relative flex flex-col shadow-lg shadow-blue-200 rounded-2xl justify-self-center justify-center items-center min-h-[600px] max-h-fit h-screen w-full max-w-[1100px] mx-auto p-2 sm:p-4">
