...
const InfoBox = ({ text, bold, link, btnText, isExternal }) => (
	<div className="sm:text-xl w-full max-w-96 px-4 sm:px-8 py-4 bg-white border-4 border-black shadow-[8px_8px_0px_rgba(0,0,0,1)] grid place-content-center text-center">
